...
$(document).ready(function () {
    ...
    if (localStorage.getItem('todos') != null) {
        ...
        $.each(todoList, function (key, value) {
            $('#todos').prepend('<li id="task-' + i + '"><a id="todo_link" href="#edit" data-todo_name="' + value.todo_name + '" data-todo_date="' + value.todo_data + '">' + value.todo_name + '<span>'+value.todo_data+'</span></a></li>');
            i++;
        });
    ...
    $('#add_form').submit(function () {
        ...
        if (todo_name == '') {
            ...
            //Create array with new todo values
            var new_todo = {
                "todo_name": todo_name,
                "todo_date": todo_date
            }
    ...
    //Insert cuurent data into edit form
